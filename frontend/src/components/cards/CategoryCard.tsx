...
export default function CategoryCard({ title, isAdmin = false }: CardProps) {
  return (
    <div className="w-52 h-96 bg-[#FFFFFF80] backdrop-blur-md hover:bg-[#FFA14AB2] transition-all rounded-3xl flex flex-col justify-evenly items-center group">
      ...
      <div className="flex gap-2">
        {isAdmin && (
          <>
            <div data-tooltip-target="tooltip-default" className="w-12 h-12 flex justify-center items-center bg-[#FFA14AB2] rounded-full group-hover:bg-white cursor-pointer">
